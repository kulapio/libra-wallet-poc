          ...
          <div v-if="'' !== $store.state.userAddress">
            ...
            <h1 class="title">
              <span v-if="!updateingBalance">
                ...
                {{ $store.state.balance }}
                <button class="button" @click="doUpdateBalance">
            ...
            <b-field><!-- Label left empty for spacing -->
              <p id="action_area" class="control">
                ...
                <button id="update_balance_button" class="button is-large is-warning" @click="doUpdateBalance">
                  Update balance
                </button>
              </p>
            </b-field>
